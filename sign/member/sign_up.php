...
<html lang="en">
  ...
  <div class="col input-group mb-2">
  <label class="input-group-text" for="inputGroupSelect01">Semeter</label>
  ...
  <select class="form-select" id="inputGroupSelect01" name="jurusan">
    ...
    <option value="Desain Fashion">Desain Fashion</option>
    <option value="S1 Keperawatan">Keperawatan</option>
    <option value="D3 Keperawatan">Keperawatan</option>
    <option value="Farmasi">Farmasi</option>
    <option value="KESMAS">KESMAS</option>
    <option value="Kebidanan">Kebidanan</option>
    <option value="Gizi">Gizi</option>
    <option value="IKORA">IKORA</option>
  ...
  <p class="d-flex justify-content-center">Already have an account? <a href="sign_in.php" class="text-decoration-none text-primary">Sign In</a></p>
</form>
</div>
  </div>
</body>
