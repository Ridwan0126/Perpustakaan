...
<html lang="en">
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-dark" role="alert">Selamat datang admin - <span class="fw-bold text-capitalize"><?php echo $_SESSION['admin']['nama_admin']; ?></span> di Dashboard Admin Perpus.UNW</div>
      
      <div class="mt-4 p-3">
        <div class="d-flex flex-wrap justify-content-center gap-2">
        <div class="cardImg">
          <a href="member/member.php">
            <img src="../assets/dashboardCardMember/member.png" alt="daftar buku" style="max-width: 70%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
          <a href="buku/daftarBuku.php">
          <img src="../assets/dashboardCardMember/bukuAdmin.png" alt="daftar buku" style="max-width: 70%;" width="600px">
          </a>
        </div>

        <div class="cardImg">
          <a href="peminjaman/peminjamanBuku.php">
            <img src="../assets/dashboardCardMember/peminjam.png" alt="daftar buku" style="max-width: 70%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
          <a href="pengembalian/pengembalianBuku.php">
          <img src="../assets/dashboardCardMember/pengembalianAdmin.png" alt="daftar buku" style="max-width: 70%;" width="600px">
          </a>
        </div>
      
         <div class="cardImg">
           <a href="denda/daftarDenda.php">
           <img src="../assets/dashboardCardMember/denda.png" alt="daftar buku" style="max-width: 70%;" width="600px">
           </a>
         </div>
        </div>
    ...
    <footer class="shadow-lg bg-subtle p-3">
      ...
      <p class="mt-2">By Wannn's Project's</p>
      </div>
    </footer>
