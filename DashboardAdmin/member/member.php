  ...
  <body>
    ...
    <div class="p-4 mt-5">
     ...
     <form action="" method="post" class="mt-5">
      ...
      <caption>Data Member Perpustakaan Ngudi Waluyo</caption>
      <div class="table-responsive mt-3">
        <table class="table table-striped table-hover">
        <thead class="text-center">
          <tr>
            <th class="bg-secondary text-light">nim</th>
            <th class="bg-secondary text-light">Kode</th>
            ...
            <th class="bg-secondary text-light">No Telepon</th>
            <th class="bg-secondary text-light">Pendaftaran</th>
