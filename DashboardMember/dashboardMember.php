...
<style>
  ...
  <body>
    ...
    <div class="mt-5 p-4">
      ...
      <div class="alert alert-secondary" role="alert">Selamat datang member - <span class="text-capitalize fw-bold"><?php echo $_SESSION['member']['nama']; ?> </span> di Dashboard Member Aplikasi Perpus.UNW</div>
    ...
    <div class="mt-3 p-3">
      <div class="mt-2 mb-4">
        ...
        <div class="cardImg">
          ...
          <img src="../assets/dashboardCardMember/peminjam.png" alt="daftar buku" style="max-width: 100%;" width="600px">
          </a>
        </div>
